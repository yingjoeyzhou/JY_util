function output = genBandpassGratingRaw(cfg, VorH)
...
% 
% INPUT:
%   cfg : structure, configuration of the grating's contrast and etc.
%   VorH: string, 'V' or 'H' corresponding to the grating's orietation.
% 
% 
% Example parameters:
%
...
% examine the input
if ~all(isfield(cfg,{'sizedeg','sizepix','freq_sd','freq_mean','ori_mean'}))
...
switch VorH
    case 'H', cfg.ori_mean = 0;
    case 'V', cfg.ori_mean = 90;
end
